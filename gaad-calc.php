...
if ( !defined( GAAD_PLUGIN_TEMPLATE_NAMESPACE . 'GAAD_PLUGIN_TEMPLATE_CALCULATIONS_CSS_DIR'))            
	define( GAAD_PLUGIN_TEMPLATE_NAMESPACE . 'GAAD_PLUGIN_TEMPLATE_CALCULATIONS_CSS_DIR', GAAD_PLUGIN_TEMPLATE_DIR . '/css/calculations' );
...
if ( !defined( GAAD_PLUGIN_TEMPLATE_NAMESPACE . 'GAAD_PLUGIN_TEMPLATE_CALCULATIONS_CSS_URL'))            
	define( GAAD_PLUGIN_TEMPLATE_NAMESPACE . 'GAAD_PLUGIN_TEMPLATE_CALCULATIONS_CSS_URL', GAAD_PLUGIN_TEMPLATE_URL . '/css/calculations' );
...
if ( !defined( GAAD_PLUGIN_TEMPLATE_NAMESPACE . 'GAAD_PLUGIN_TEMPLATE_AUTOSAVE_CALCULATIONS_TYPES') )
	...
	*/
	define( GAAD_PLUGIN_TEMPLATE_NAMESPACE . 'GAAD_PLUGIN_TEMPLATE_AUTOSAVE_CALCULATIONS_TYPES', '5,10' );




if ( !defined( GAAD_PLUGIN_TEMPLATE_NAMESPACE . 'GAAD_PLUGIN_TEMPLATE_AUTOSEND_CALCULATION_TO_CONTRACTOR_ON_SAVE') )
	/**	
	* Forces to upload template files
	*/
	define( GAAD_PLUGIN_TEMPLATE_NAMESPACE . 'GAAD_PLUGIN_TEMPLATE_AUTOSEND_CALCULATION_TO_CONTRACTOR_ON_SAVE', false );
