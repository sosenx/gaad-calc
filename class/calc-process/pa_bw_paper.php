...
class pa_bw_paper extends \gcalc\cprocess{
	...
	function __construct( $product_attributes, $product_id, \gcalc\calculate $parent, $group ){	
		...
		if ( $valid ) {
			...
			$this->calculator = new \gcalc\calc\pa_bw_paper( $this->cargs, $product_id, $parent, $group, $this );
			return $this;
		} else { return false; }
	...
	/**
	 * Process based attributes validation
	...
	/**
	 * Product based attributes validation
	 * 
